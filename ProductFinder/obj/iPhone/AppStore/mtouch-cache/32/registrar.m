...
void xamarin_create_classes () {
	...
	__xamarin_class_map [46].handle = objc_getClass ("UISearchBar");
	__xamarin_class_map [47].handle = objc_getClass ("UISegmentedControl");
	...
	__xamarin_class_map [55].handle = objc_getClass ("CLBeaconRegion");
	__xamarin_class_map [56].handle = objc_getClass ("CLBeacon");
